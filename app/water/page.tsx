  ...
  return (
    <>
      ...
      <ul className="list-disc ml-6 space-y-2">
        ...
        <li>They travel through wastewater and can re-enter the environment via sludge (“biosolids”).</li>
        <li>Removing PFAS from finished drinking water requires specific treatment (e.g., carbon or membranes).</li>
      </ul>
