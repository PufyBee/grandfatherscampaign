...
const HERO_SRC = "/images/vote-rod-mayor.png"; // change if your hero file name/ext is different
    ...
    <div id="top" className="mx-auto max-w-5xl px-4">
      ...
      <nav className="mb-8">
        <ul className="flex flex-wrap gap-3 text-sm">
          <li><a href="#s1" className="underline hover:no-underline">This website contains information concerning Montevallo’s dangerous drinking water.</a></li>
          <li><a href="#s2" className="underline hover:no-underline">Mayor Nix’s False and Misleading statements (2019-2025)</a></li>
          <li><a href="#s3" className="underline hover:no-underline">Dr. Roderick MacPherson’s professional qualification to be mayor.</a></li>
          <li><a href="#s4" className="underline hover:no-underline">General questions for Montevallo’s residents</a></li>
        </ul>
      </nav>
      ...
      <section id="s1" className="mb-12">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <p>
              PFAS are connected to developmental disorders, cardiovascular diseases, metabolic illnesses, and
              various cancers.
            </p>
          </div>
          <div>
            ...
            <p>
              PFAS can cause reproductive damage, delayed fetal growth, increased blood pressure, high
              cholesterol, suppress the immune system, thyroid disease, preeclampsia, and introduce cancers
              (breast, ovarian, liver, bladder, and so on).
            </p>
          </div>
          <div>
            <h4 className="font-medium">Men:</h4>
            <p>
              PFAS can cause assorted ailments, stomach problems, assorted diseases, and cancers (testicular,
              kidney, prostrate, thyroid, etc.).
            </p>
          </div>
        </div>
      ...
      <section id="s2" className="mb-12">
        <h2 className="text-2xl font-semibold mb-3">
          Mayor Nix’s False and Misleading statements (2019-2025)
        </h2>
        <p className="mb-4">
      ...
      <section id="s3" className="mb-12">
        ...
        <p className="mb-4">
          ...
          state government, and consulting experience — presented in Rod’s own words.
        </p>
        <Link
          href="/background"
          className="inline-block rounded-md bg-gray-100 px-5 py-3 font-medium hover:bg-gray-200"
        >
          Read Rod’s background (verbatim)
        </Link>
      </section>
      ...
      <section id="s4" className="mb-12">
        <h2 className="text-2xl font-semibold mb-3">
          General questions for Montevallo’s residents
        </h2>
        <ul className="list-disc ml-6 space-y-2">
          <li>
            Were you or your neighbors ever told during Mayor Nix’s term in office that Montevallo’s drinking
            water was contaminated with toxic and carcinogenic chemicals?
          </li>
          <li>
            Did Mayor Nix have an obligation to inform you of the upcoming demolition of the Historic Victory
            Building (a Hazardous Waste site) and the gasoline station next to the old Alabama Power building?
          </li>
          <li>
            If a legal precedent was established with the Cobblestone contract, do you feel the town’s taxpayers
            were obligated to higher taxes in the future without their knowledge?
          </li>
          <li>
            Should apartment owners and land developers be permitted to pursue building plans that worsen flooding
            and damage the stormwater system, or violate zoning while homeowners must comply?
          </li>
        </ul>
      </section>
